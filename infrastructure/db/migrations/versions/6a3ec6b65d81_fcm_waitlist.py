...
Revision ID: 6a3ec6b65d81
Revises: 749b5a5a2382
Create Date: 2026-06-22 08:37:31.934351
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_device_tokens_active'), 'device_tokens', ['active'], unique=False)
